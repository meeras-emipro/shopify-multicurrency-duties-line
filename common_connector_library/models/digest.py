    ...
    def get_orders_average(self, domain):
        ...
        for record in self:
            ...
            all_channels_sales = self.env['sale.report'].read_group([
                ...
                ('company_id', '=', company.id), domain[0]], ['price_total'], ['price_total'])
            record.kpi_avg_order_value_value = sum([channel_sale['price_total'] for channel_sale in all_channels_sales])
